...
<a target="_blank" href="https://cryptoinfoapp.netlify.app/">
          <img src="" width="100%" alt="Crypto Info App"/>
</a>
<br>
...
[Crypto-Info-API](https://crypto-info-api.herokuapp.com/) allow developers to use NASA’s data, such as imagery, for application development. The NASA APOD API and presents the best astrophotographic photo of NASA resources every day.
...
While improving this project, I would start by implementing the following features -
   ...
   2. Implement more APIs endpoints
